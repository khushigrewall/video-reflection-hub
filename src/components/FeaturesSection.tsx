    ...
    <section id="features" className="w-full max-w-6xl mx-auto px-4 py-20">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {features.map((feature, index) => (
          <Card key={index} className="bg-card-gradient backdrop-blur-md border-cream/30 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 group">
      ...
      {/* Premium Features */}
      <div className="mt-16 p-8 bg-card-gradient backdrop-blur-md rounded-3xl border border-cream/30 shadow-xl">
        <div className="flex items-center justify-center mb-6">
          <Crown className="w-8 h-8 text-terracotta mr-3" />
