  ...
  return (
    <section className="w-full max-w-4xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-warm-brown/70 text-xl font-poppins max-w-3xl mx-auto font-medium animate-fade-in" style={{ animationDelay: '0.1s' }}>
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <Card className="bg-card-gradient backdrop-blur-md border-cream/30 p-6 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <div className="aspect-video bg-gradient-to-br from-soft-peach/60 to-cream/60 rounded-2xl relative overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-card-gradient backdrop-blur-md rounded-full p-6 hover:bg-soft-peach/40 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl hover:scale-110 animate-glow">
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-warm-brown/80 backdrop-blur-md rounded-lg p-3 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-1 bg-cream/60 rounded-full">
                  <div className="w-3 h-1 bg-terracotta rounded-full animate-pulse"></div>
                </div>
                <span className="text-cream text-sm font-poppins">2:34</span>
              </div>
              <Volume2 className="w-5 h-5 text-cream animate-glow" />
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start space-x-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <div className="bg-soft-peach/60 p-3 rounded-2xl animate-float">
