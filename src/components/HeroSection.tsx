    ...
    <section className="w-full max-w-6xl mx-auto px-4 py-20">
      <div className="text-center mb-16">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
          <Button className="bg-peach-gradient hover:opacity-90 text-warm-brown border border-cream/40 px-10 py-5 text-lg font-poppins font-semibold rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
            <Video className="w-6 h-6 mr-3" />
            Start Your Journey
          </Button>
          <Button variant="ghost" className="text-warm-brown hover:bg-cream/20 border border-cream/40 px-10 py-5 text-lg font-poppins font-medium rounded-2xl backdrop-blur-md transition-all duration-300">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <Card className="bg-card-gradient backdrop-blur-md border-cream/30 p-6 rounded-2xl text-center hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <Card className="bg-card-gradient backdrop-blur-md border-cream/30 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 group">
          <div className="bg-soft-peach/60 w-16 h-16 rounded-2xl flex items-center justify-center mb-6">
